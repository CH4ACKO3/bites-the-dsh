...
const en: Record<PlaybackLocaleKey, string> = {
  ...
  retryOlderHistory: 'Retry loading older history',
  historyLoading: 'Loading earlier history…',
  historyLoadFailed: 'Earlier history failed — Retry',
  rate: 'Playback speed',
  skipIdle: 'Skip idle',
  simulateTyping: 'Simulated typing',
...
const zh: Record<PlaybackLocaleKey, string> = {
  ...
  forward: '正放',
  stepForward: '下一个事件',
  retryOlderHistory: '重试加载更早历史',
  historyLoading: '正在加载更早历史…',
  historyLoadFailed: '更早历史加载失败，重试',
  rate: '播放速度',
  skipIdle: '跳过空闲',
  simulateTyping: '模拟输入',
  idleLimit: '最多保留的空闲时长',
